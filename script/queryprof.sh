...
queryfile=${1}
basename_woext=${1%.*}
ioproffile=/data/local/keisuke/tpch/${basename_woext}.io
cpuproffile=/data/local/keisuke/tpch/${basename_woext}.cpu
resultfile=/data/local/keisuke/tpch/${basename_woext}.res
